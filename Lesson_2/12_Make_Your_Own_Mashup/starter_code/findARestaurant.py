...
foursquare_client_id = "NDWWLYIDSYT2W4P0I0GLLPC3JIUUETCRIS2WR3DYMEFH1BA4"
foursquare_client_secret = "03MDVEPM23KZELXHI1MAT4NMPPBOA2RJPHBISW2QCD5QEMYO"
...
def findARestaurant(mealType,location):
	...
	if result['response']['photos']['items']:
		firstimg = result['response']['photos']['items'][0]
	...
	restaurantInfo = {'name': restaurant_name, 'address': restaurant_address, 'image': imgURL}
